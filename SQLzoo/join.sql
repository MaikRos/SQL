...
*/
SELECT teamname, count(goal.teamid) AS goals
...
/* 13.
List every match with the goals scored by each team as shown below
...
SELECT mdate,
    ...
    END) AS score1,
    team2,
    sum(CASE WHEN team2=goal.teamid
        THEN 1
        ELSE 0
    END) AS score2
